document.addEventListener('DOMContentLoaded', () => {
    ...
    if (btnCalendario) {
        ...
        if (isIOS) {
            ...
            const webUrl = encodeURIComponent("https://calendar.google.com/calendar/render?action=TEMPLATE&text=Mis+XV+Años+|+Andrea&dates=20260703T170000/20260704T020000&details=¡Te+invito+a+celebrar+mis+XV+años!+No+faltes.&location=Iglesia+Capilla+de+Guadalupe+/+Salón+Millan");
            ...
            const urlGoogle = "https://calendar.google.com/calendar/render?action=TEMPLATE&text=Mis+XV+A%C3%B1os+%7C+Andrea&dates=20260703T170000/20260704T020000&details=%C2%A1Te+invito+a+celebrar+mis+XV+a%C3%B1os!+No+faltes.&location=Iglesia+Capilla+de+Guadalupe+/+Sal%C3%B3n+Millan";
